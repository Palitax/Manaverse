-- ==============================================================================
-- MANAVERSE COMMUNITY PLATFORM - HARDENED SECURITY DATABASE SCHEMA
-- ==============================================================================

-- 1. PROFILES (Strictly no sensitive contact details or private emails in public queries)
...
-- Public profiles are viewable by everyone (contains only public display info)
...
-- Only listing owner or offer creator can view trade offers
create policy "Trade offers viewable by participants only"
...
-- 4. BULK SUBMISSIONS ("An Manacards verkaufen") - STRICT PRIVACY
...
-- STRICT: Bulk submissions can ONLY be viewed by the creator or Manacards admins
create policy "Bulk submissions viewable strictly by creator or admin"
...
-- Only deal participants can view the deal
create policy "Deals viewable by deal participants only"
